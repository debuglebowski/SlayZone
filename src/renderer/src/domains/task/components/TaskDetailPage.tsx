...
import { DeleteTaskDialog } from '@/domains/task/components/DeleteTaskDialog'
import { Tooltip, TooltipTrigger, TooltipContent } from '@/components/ui/tooltip'
import { TaskMetadataSidebar } from './TaskMetadataSidebar'
import { RichTextEditor } from '@/components/ui/rich-text-editor'
import { Terminal } from '@/domains/terminal/components/Terminal'
import { markSkipCache } from '@/domains/terminal/components/terminal-cache'
        ...
        <div className="flex-1 min-w-0 bg-[#0a0a0a] flex flex-col">
          ...
          <div className="flex-1 min-h-0 m-4 flex flex-col">
            <div className="flex-1 min-h-0 border border-neutral-800 rounded-lg overflow-hidden">
              {project?.path ? (
                <ErrorBoundary key={terminalKey} onReset={handleRestartTerminal}>
                  <Terminal
                    taskId={task.id}
                    cwd={project.path}
