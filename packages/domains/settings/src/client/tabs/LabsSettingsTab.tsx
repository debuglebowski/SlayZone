...
const LABS_FEATURES = [
  ...
  { key: 'labs_agent_manager', label: 'Agent Manager Mode', description: 'Toggle a sidebar showing the subtask tree and swap the terminal to any subtask’s session', loader: () => window.api.app.isAgentManagerEnabled() },
