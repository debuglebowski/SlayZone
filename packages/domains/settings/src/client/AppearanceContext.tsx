...
export function AppearanceProvider({
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      termArchiveCapMb, termArchiveInitialLines, termArchiveStepLines,
      diffContext, diffWs,
      ...
      setSettings({
        ...
        terminalArchiveCapMb: termArchiveCapMb ? Math.max(1, parseInt(termArchiveCapMb, 10) || d.terminalArchiveCapMb) : d.terminalArchiveCapMb,
        terminalArchiveInitialLines: termArchiveInitialLines ? Math.max(50, parseInt(termArchiveInitialLines, 10) || d.terminalArchiveInitialLines) : d.terminalArchiveInitialLines,
        terminalArchiveStepLines: termArchiveStepLines ? Math.max(50, parseInt(termArchiveStepLines, 10) || d.terminalArchiveStepLines) : d.terminalArchiveStepLines,
